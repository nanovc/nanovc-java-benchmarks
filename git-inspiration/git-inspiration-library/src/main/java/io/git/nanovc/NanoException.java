...
/**
 * An exception from the Nano Version Control system.
 * This exception indicates a situation that can be recovered from and is therefore a checked exception.
 * For an unchecked exception see {@link NanoRuntimeException}
 */
